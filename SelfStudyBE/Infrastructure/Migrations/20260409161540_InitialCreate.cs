    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OcrImages", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxFlashcardsPerDay = table.Column<int>(type: "int", nullable: false),
                    MaxQuizPerDay = table.Column<int>(type: "int", nullable: false),
                    MaxAIUsagePerDay = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Headings_Headings_ParentId",
                        column: x => x.ParentId,
                        principalTable: "Headings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Headings_Subjects_SubjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Flashcards_Contents_ContentId",
                        column: x => x.ContentId,
                        principalTable: "Contents",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Flashcards_Headings_HeadingId",
                        column: x => x.HeadingId,
                        principalTable: "Headings",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Questions_Headings_HeadingId",
                        column: x => x.HeadingId,
                        principalTable: "Headings",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AcceptedAnswers", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlashcardQuestions", x => new { x.FlashcardId, x.QuestionId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlashcardQuestions_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuizAnswers_Answers_SelectedAnswerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlashcardQuestions_QuestionId",
                table: "FlashcardQuestions",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_Flashcards_ContentId",
                table: "Flashcards",
                column: "ContentId");

            migrationBuilder.CreateIndex(
                name: "IX_Flashcards_HeadingId",
                table: "Flashcards",
                column: "HeadingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Headings_ParentId",
                table: "Headings",
                column: "ParentId");

            migrationBuilder.CreateIndex(
                name: "IX_Headings_SubjectId",
                table: "Headings",
                column: "SubjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizAttempts_AppUserId",
                table: "QuizAttempts",
                column: "AppUserId");
